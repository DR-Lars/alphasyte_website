    ...
    <div class="relative flex h-16 items-center justify-between">
      ...
      >
        <div class="flex flex-shrink-0 items-center">
          <img class="h-8 w-auto" src={logo} alt="Alphasyte" />
        </div>
        <div class="hidden sm:ml-6 sm:block">
          <div class="flex space-x-4">
            ...
            <a
              href="/appointment"
              class="rounded-md bg-gradient-to-l from-cyan-400 to-green-400 px-3 py-2 text-sm font-medium text-white"
              aria-current="page">Afspraak</a
            >
            <a
              href="#"
              class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gradient-to-r from-cyan-300 to-green-300 hover:text-white"
...
<main class="grid grid-cols-1 gap-x-6 gap-y-3 px-5 py-3 sm:grid-cols-2">
  <section class="flex flex-col space-y-4">
    <h1 class="text-xl font-semibold">Make an Appointment</h1>
